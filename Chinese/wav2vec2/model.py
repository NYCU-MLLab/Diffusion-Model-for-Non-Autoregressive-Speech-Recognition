...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.wav2vec2.config.mask_time_prob = 0.1

        del self.wav2vec2.feature_extractor
    ...
    def forward(self, features, attention_mask):
        hidden_states, extract_features = self.wav2vec2.feature_projection(features)
...
class Decoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.emb = nn.Embedding(3113, 768)
